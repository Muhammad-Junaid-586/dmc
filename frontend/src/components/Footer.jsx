    ...
    <footer className="bg-gray-900  py-16 no-print">
      <div className="max-w-7xl mx-auto px-6 md:px-12 grid grid-cols-1 md:grid-cols-3 gap-12">
        ...
        <div>
          ...
          <p className=" mt-5 leading-relaxed" style={footerText}>
